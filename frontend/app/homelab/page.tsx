...
export default async function HomelabPage() {
  ...
  return <main className="mx-auto min-h-screen max-w-5xl px-6 py-12 sm:px-10">
    <header><p className="text-sm font-medium uppercase tracking-[0.2em] text-cyan-300">Homelab</p><h1 className="mt-3 text-4xl font-semibold text-white">Pulse inventory</h1><p className="mt-3 max-w-xl text-sm text-slate-400">Read-only actuele status uit Pulse. Bron-update: {homelab.last_updated_at}.</p></header>
