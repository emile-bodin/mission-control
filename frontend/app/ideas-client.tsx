...
export function IdeasClient() {
  ...
  async function submitCapture(event: FormEvent<HTMLFormElement>) {
    event.preventDefault();
    if (captureKind === "voice_reference") {
      if (!voiceReference.trim()) return;
      await mutate("/api/stream-entries", "POST", { kind: captureKind, voice_reference: { source: "browser", reference_id: voiceReference } });
      setVoiceReference("");
      return;
    }
