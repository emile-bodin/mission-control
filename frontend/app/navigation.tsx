  ...
  return (
    <nav className="mt-8 grid grid-cols-2 gap-1 sm:grid-cols-3 md:block md:space-y-1" aria-label="Hoofdnavigatie">
      {items.map((item) => {
        ...
        const className = `flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-colors ${active ? "bg-indigo-500/25 text-indigo-100 shadow-[inset_0_1px_0_rgba(129,140,248,0.22)]" : "text-slate-400 hover:bg-slate-800/80 hover:text-white"}`;
